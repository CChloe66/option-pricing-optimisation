...
int main(int argc , char  **argv) {
    ...
    unsigned timeStep = 4096; // Number of asset sample intervals
    ...
    // Each loop executes MC simulations nbSim times - to compare results for 10 to 10^7 simulations 
    for(nbSim = 10 ; nbSim <= 10000000 ; nbSim*=10) {
