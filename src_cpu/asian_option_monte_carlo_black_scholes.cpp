...
// // Simulates one path for the underlying asset price using the Black-Scholes model
// double simulate_path(double S0, double T, double r, double sigma, int num_points) {
